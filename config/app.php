...
$APP = [
    ...
    'APP_URL' 			=> 'http://localhost/donate', // NOTE : Don't put the slash at the end  of the URL / if you're install the script in sub category include it in the URL eg exemple.com/sub
